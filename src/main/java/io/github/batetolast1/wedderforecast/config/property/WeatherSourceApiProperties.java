...
public class WeatherSourceApiProperties {
    ...
    public WeatherSourceApiProperties(String apiKey, String host, String path, String timestampQuery, String fieldsQuery, String dailyFields, String hourlyFields) {
        this.apiKey = apiKey;
        this.host = host;
        this.path = path;
